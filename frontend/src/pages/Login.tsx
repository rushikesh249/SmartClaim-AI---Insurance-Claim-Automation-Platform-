            ...
            <div className="w-full md:w-[480px] xl:w-[520px] flex items-center justify-center px-6 py-10 bg-white flex-shrink-0">
                <div className="w-full max-w-md space-y-6">
                    ...
                    <div className="items-center flex justify-center">
                        <p className="text-sm text-muted-foreground">Don't have an account? <Link to="/register" className="underline underline-offset-4 hover:text-primary">Sign up</Link></p>
                    </div>
                </div>
            </div>
